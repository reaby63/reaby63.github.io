...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function getVisibleCount() {
      if (window.innerWidth <= 335) return 4;
      if (window.innerWidth <= 370) return 5;
      if (window.innerWidth <= 406) return 6;
      if (window.innerWidth <= 410) return 7;
      if (window.innerWidth <= 490) return 5;
      if (window.innerWidth <= 590) return 6;
    ...
    function getIconWidth() {
      if (window.innerWidth <= 410) return 37;
      if (window.innerWidth <= 434) return 47;
    ...
    function updateView(smooth = false) {
      ...
      const offset = startIndex * iconWidth; // 每個 icon 寬度
