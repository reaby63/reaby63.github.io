...
$(document).ready(function() {
    ...
    const elementsToObserve = [
      { selector: '.serve_self , .phone , .mail , .web ,.c_contact_title', className: 'each_an' },
      { selector: ' #c_portfolio_title , #c_portfolio_p , #social_place , .cb_logo , .cb_list', className: 'fadeIn' },
      { selector: ' #c_contact ', className: 'each_an' }
