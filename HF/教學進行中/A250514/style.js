...
const clock =  setInterval(switchPlus, 3000)

// 頁籤切換-簡化版 index是參數 專門給該function使用的參數
function changePage(index) { 
    imgNum = index;
    document.getElementById('carousel_img_scroll').innerHTML = `<img src="${imgList[index]}" alt="">`
    console.log('page' + imgNum)
