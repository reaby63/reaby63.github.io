...
let jhuangPing = {
  ...
  tabs: function () {
    let _showTab = 0;
    let $defaultLi = $('ul.c-tab li').eq(_showTab);
    $defaultLi.find('a').addClass('active');
    $($defaultLi.find('a').attr('href')).siblings().hide();

    // 當 li 頁籤被點擊時...
    // 若要改成滑鼠移到 li 頁籤就切換時, 把 click 改成 mouseover
    $('ul.c-tab a').click(function () {
      // 找出 li 中的超連結 href(#id)
      let $this = $(this),
        _clickTab = $this.attr('href');
        _clickName = $this.text();
      // 把目前點擊到的 li 頁籤加上 .active
      // 並把兄弟元素中有 .active 的都移除 class
      $('ul.c-tab a').removeClass('active');
      $this.addClass('active');
      // 淡入相對應的內容並隱藏兄弟元素
      $(_clickTab).stop().fadeIn(800).siblings().stop().hide();

      $('.c-tab-switch .js-open .c-btn__label').text(_clickName);
      $('.c-tab-switch').removeClass('is-open');
  ...
  menu: function () {
    let hd = $('.hd'),
      ...
      menuCtr = $('.menu-block'),
      menuBuildMask = $('<div class="el-mask"></div>'),
    ...
    let menu = {
      ...
      click: function () {
        ...
        function hamburgerToggle() {
          ctr.toggleClass('show');
          btn.toggleClass('active');
          $('.hd').toggleClass('menu-open');
          bodyLock();

          // 關閉其他元素
          $('.mobile-lang-list').removeClass('open');
        ...
        hd.find('.el-mask').click(function () {
          hamburgerToggle();
        });
        ...
        $('.menu-list__link').click(function (e) {
          ...
          let targetPosition = $(target).offset()?.top - $('.hd').height() + 10;
...
let swiper = {
  index: function () {
    let fixedSideCommunity = $('.js-swiper-fixed-side .swiper-slide').length;
    fixedSideCommunity > 1 ? $('.js-swiper-fixed-side').removeClass('is-item-only') : $('.js-swiper-fixed-side').addClass('is-item-only');
    let fixedSideSwiper = new Swiper('.js-swiper-fixed-side .swiper-container', {
      slidesPerView: 4,
      spaceBetween: 15,
      direction: 'vertical',
      loop: fixedSideCommunity > 1 ? true : false,
      navigation: {
          nextEl: '.js-swiper-fixed-side .js-btn-next',
        },
    });

    let menuCommunitySwiper =new Swiper('.js-swiper-menu-community .swiper-container', {
      slidesPerView: 4,
      spaceBetween: 6,
      navigation: {
          nextEl: '.js-swiper-menu-community .js-btn-next',
          prevEl: '.js-swiper-menu-community .js-btn-prev'
        },
    });
    ...
    for (let i = 0; i < 3; i++) {
      let thisEle = `.js-swp-idx-photo${i + 1} .swiper-container`;
      let thisDot = `.js-swp-idx-photo${i + 1} .js-swp-idx-photo-dot`;
      let thisNext = `.js-swp-idx-photo${i + 1} .js-btn-next`;
      let thisPrev = `.js-swp-idx-photo${i + 1} .js-btn-prev`;

      let photoSwiper = new Swiper(thisEle, {
        slidesPerView: 1,
        spaceBetween: 0,
        effect: 'fade',
        fadeEffect: {
...
let page = {
  init: () => {
    ...
    // fixed side
    $('.js-open-fixed-label').click(function () {
      $(this).addClass('is-active')
      $(this).next('.fixed-label').addClass('is-open')
    })
    $('.js-close-fixed-label').click(function () {
      $('.fixed-label-toggle').removeClass('is-active')
      $('.fixed-label').removeClass('is-open')
    })
    ...
    jhuangPing.lightbox({
      init: function () {
        ...
        let saleLbxSwiper = new Swiper('.js-swp-sale-lbx .swiper-container', {
          slidesPerView: 1,
          spaceBetween: 0,
          effect: 'fade',
          fadeEffect: {
          ...
          navigation: {
            nextEl: '.js-swp-sale-lbx .js-btn-next',
            prevEl: '.js-swp-sale-lbx .js-btn-prev'
          },
        });
    ...
    jhuangPing.tabs();
    $('.c-tab-switch__toggle .js-open').click(function () {
      $('.c-tab-switch').toggleClass('is-open');
      bodyLock();
    })
    $('.c-tab-switch .js-close').click(function () {
      $('.c-tab-switch').toggleClass('is-open'); 
      bodyLock();
    });
    ...
    // toolbar
    $('.c-btn-fixed-focus').click(function () {
      $('.c-btn-fixed-focus').toggleClass('active');
      $('.c-btn-fixed-focus').find('.c-btn__label').text(($(this).find('.c-btn__label').text() === "已關注") ? "關注" : "已關注")
    });

    // news
    if ($('.news-list__item').length > 3) {
      $('.news-lists').addClass('is-scroll')
    }
